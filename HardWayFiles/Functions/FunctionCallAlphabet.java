...
public class FunctionCallAlphabet
{
	public static void main( String[] args )
	{
		...
		e(8);    // pass it the number of letters to display (9)
		...
		i(1);    // pass it any integer and it will display a word beginning with I 
		System.out.print(j(3));    // returns a different word depending on what you pass it (1-3)
		k();    // displays a word beginning with K
		l( false, false);    // displays a different word depending on the two booleans you pass it
		...
		System.out.print( r( false ) );    // returns a different word depending on if you pass it 'true' or 'false'
		s( 5 );    // pass it the number of letters to display (6)
		...
		w(8);    // pass it any integer and it will display a word beginning with W 
