...
public class MadLibRandom
{
	public static void main(String[] args)
	{
		...
		String[] colors = { "red", "orange", "yellow", "blue", "purple", "zzzzz",
			"white", "black", "pink", "brown", "grey", "hazel", "burnt orange" };
		...
		int ai2  = 0 + (int)(Math.random()* adverbs.length  ); // adjectuve 2
		...
		System.out.printf(color + ", and there were colorful wildflowers all around. %s and %s\n", male, female );
		...
		System.out.printf("\"Don't be such a(n) %s! We're going in. I think it looks " + ai2 + "\n", noun2 );
