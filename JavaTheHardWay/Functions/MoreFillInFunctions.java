...
public class MoreFillInFunctions
{
	public static void main( String[] args )
	{
		...
		hi = 10;
		;
		System.out.println("First: " + superrand(val1, val2));
		superrand(val1, val2); 
		System.out.println("Second: " + superrand(val1, val2) );
		if ( val1 == val2 )
		...
		System.out.println();
		System.out.print("More counting, but this time not by ones: " + stepcount(lo,hi,2));
		...
		int a=4,b=3,c=4,d=5,e=2,f=1, result=0;
		
		System.out.println("434521 -> " + project_grade(4,3,4,5,2,1) );
