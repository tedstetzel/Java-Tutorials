...
public class DoWhileSwimming
{
	public static void main(String[] args) throws Exception
	{
		...
		savedTemperature = currentTemperature; //saves a copy of value so it can be retrived later
		...
		while (currentTemperature >= minimumTemperature)
		{
			...
			swimTime++;
			Thread.sleep(600);//pauses for 600 ms
		...
		currentTemperature = savedTemperature; // restores origional water temperature
		...
		do //do is a post test loop, doesn't check before it runs. Runs a bit of code than goes into a while loops
		{
